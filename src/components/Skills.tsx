...
const Skills = () => {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["React.js", "Next.js", "Node.js", "MongoDB", "Express.js", "MERN Stack"]
    },
    {
      title: "Coursework",
    ...
    <section id="skills" ref={sectionRef} className="section-padding px-6 relative">
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="mb-4 skills-animate opacity-0">
            Technical Skills
          </h2>
        ...
        <div className="mt-16 text-center skills-animate opacity-0">
          <p className="text-foreground/70 mb-4">
            I've solved over <span className="font-medium text-primary">2000+</span> algorithmic problems on platforms like Codeforces, CodeChef, and others.
          </p>
          <a 
